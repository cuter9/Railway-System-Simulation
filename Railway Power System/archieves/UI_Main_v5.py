...
class RailSystemMenu(Menu):
    ...
    def _train_res(self):
        ...
        frame_data = {'title': 'Train Resistance Profile',
...
class OpParamsFrm(Frame):
    ...
    def show_params(self):
        ...
        self.p_subfrm.append(ParamsFrm(self.p_frm, self.df_case, [sheet_c1, sheet_c3]))
        ...
        self.p_ntbk_r.pack(side=TOP, fill=X)
